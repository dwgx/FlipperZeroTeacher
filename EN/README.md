# FlipperZero English Entry

If you prefer English reading, start from this directory.

## 1. Recommended order

1. [English learning tree](Guide/README.md)
...
- If you are a beginner, start with `Guide/README.md`
